 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * | B.tick |   1  |   2  |   3  |   4  |   5  |ALT+S |           |      |  6   |   7  |   8  |   9  |   0  |   =    |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 ...
 */
[0] = LAYOUT_ergodox(
	KC_TILD,   KC_1,       KC_2,       KC_3,       KC_4,    KC_5, LALT(KC_LSHIFT),
	KC_TAB,    KC_Q,       KC_W,       KC_E,       KC_R,    KC_T, TG(2),
	KC_ESCAPE, KC_A,       KC_S,       KC_D,       KC_F,    KC_G,
	KC_LSHIFT, KC_Z,       KC_X,       KC_C,       KC_V,    KC_B, TG(1),
	MO(2),     LCTL(KC_C), LCTL(KC_X), LCTL(KC_V), MO(1),
	                                          KC_DELETE, KC_TRNS,
	                   
 KC_LGUI,
	                              KC_BSPACE,CTL_T(KC_NO),KC_LALT,
	
	LALT(KC_LSHIFT),   KC_6,    KC_7,        KC_8,        KC_9,      KC_0,     KC_EQUAL,
	MO(2),   KC_Y,    KC_U,        KC_I,        KC_O,      KC_P,     KC_BSLS,
	KC_H,    KC_J,    KC_K,        KC_L,        KC_SCLN,   KC_MINUS,
	MO(1),   KC_N,    KC_M,        KC_COMM,     KC_DOT,    KC_SLSH,  KC_LSHIFT,
